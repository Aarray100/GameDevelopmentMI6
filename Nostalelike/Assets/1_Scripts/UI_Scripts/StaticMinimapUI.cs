...
public class StaticMinimapUI : MonoBehaviour
{
    ...
    [Tooltip("Zoom-Stufe 1: 100% (ganze Karte)")]
    public float zoom100Percent = 1.0f;
    
    [Tooltip("Zoom-Stufe 2: 50% (näher herangezoomt)")]
    public float zoom50Percent = 0.5f;
    
    private bool isZoomedIn = false; // false = 100%, true = 50%
    ...
    /// <summary>
    /// Wechselt zwischen 50% und 100% Zoom
    /// </summary>
    private void CycleZoomLevel()
    {
        isZoomedIn = !isZoomedIn;
        float currentZoom = isZoomedIn ? zoom50Percent : zoom100Percent;
        Debug.Log($"Minimap Zoom: {currentZoom * 100}% (gezoomt auf {(isZoomedIn ? "50%" : "100%")} der Karte)");
    }
    ...
    private void UpdatePlayerIcon()
    {
        ...
        // Hole aktuellen Zoom-Faktor (50% oder 100%)
        float currentZoom = isZoomedIn ? zoom50Percent : zoom100Percent;
