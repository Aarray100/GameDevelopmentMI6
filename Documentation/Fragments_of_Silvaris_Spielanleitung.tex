...
Die Hotbar am unteren Bildschirmrand bietet 10 Schnellzugriff-Slots:
\begin{itemize}
    \item Ziehe Items (meist Tränke) aus dem Inventar in die Hotbar
    \item Verwende Hotbar-Items mit den Tasten \textbf{1-9, 0}
...
\begin{enumerate}
    ...
    \item \textbf{Heile regelmäßig}: Kaufe Heiltränke und lege sie auf die Hotbar (1-9, 0) für schnellen Zugriff
...
\hline
1 bis 0 & Hotbar-Items verwenden \\
\hline
\end{tabular}
