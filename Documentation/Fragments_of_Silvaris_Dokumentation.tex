...
Das Projekt wurde von einem Team über einen Zeitraum von September 2025 bis Februar 2026 entwickelt und erfolgreich umgesetzt.
...
\acro{FSM}{Zustandsmaschine (Finite State Machine)}
\acro{SFX}{Soundeffekte (Sound Effects)}
...
Entwicklungszeitraum: September 2025 -- Februar 2026
...
Der Spieler kontrolliert einen Abenteurer, der die Mission hat, die Slime-Invasion zu stoppen. Der Charakter hat vier verschiedene Erscheinungsformen zur Auswahl, was eine gewisse Personalisierung ermöglicht.
...
\begin{itemize}
    ...
    \item \textbf{Kaufleute}: NPCs die Items kaufen und verkaufen
...
\begin{itemize}
    ...
    \item \textbf{Hotbar}: Schnellzugriff auf 5 Items
...
In frühen Spielversionen führten Gegner Angriffe instant durch. Dies führte zu Spieler-Frustration, da keine Reaktionsmöglichkeit existierte. Das Telegraph System löst dies durch eine "Vorwarnungszeit" vor dem eigentlichen Schaden.
...
\begin{description}
    \item[Phase 1 (Sep--Oct 2025)]: \textbf{Core Mechanics}
    \begin{itemize}
...
Das Team bestand aus Aaron Seitz (3006614), Robin Fitzek (3006199), Burak Yigit (3005865) und Paul Weber (88487), die gemeinsam über einen Zeitraum von September 2025 bis Februar 2026 an diesem Projekt gearbeitet haben.
